...
def predict(model, input_df):
    ...
    #exp_regr = setup(data = input_df, target = 'actual_ratings',numeric_features=numerical_features,session_id=123) 
    #exp_regr = setup(data = input_df, target = 'user_review',use_gpu = False, silent = True ) 
